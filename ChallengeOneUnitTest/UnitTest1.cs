...
namespace ChallengeOneUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void NewItem_AddsItemToList()
        {
            ...
            _menu.NewItem(menuNumber, menuItem, description, ingredientList, price);

            Assert.AreEqual(comparison[0].MealNumber, _menu.menu[0].MealNumber);
            Assert.AreEqual(comparison[0].MealName, _menu.menu[0].MealName);
            Assert.AreEqual(comparison[0].Description, _menu.menu[0].Description);
            Assert.AreEqual(comparison[0].Ingredients, _menu.menu[0].Ingredients);
            Assert.AreEqual(comparison[0].Price, _menu.menu[0].Price);
        }
        ...
        public void DeleteItem_RemovesAnItem()
        {
            ...
            Assert.IsFalse(_menu.DeleteItem(firstItemToRemove));
            Assert.IsTrue(_menu.DeleteItem(menuNumber));
        }
